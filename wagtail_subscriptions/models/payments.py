...
class Invoice(models.Model):
    ...
    def __str__(self):
        return f"Invoice {escape(self.invoice_number)} - {escape(str(self.customer))}"
...
class Payment(models.Model):
    ...
    def __str__(self):
        return f"Payment {escape(self.external_id)} - ${self.amount} ({escape(self.status)})"
...
class WebhookEvent(models.Model):
    ...
    def __str__(self):
        return f"{escape(self.payment_processor)} - {escape(self.event_type)} ({escape(self.external_id)})"
