...
class Feature(models.Model):
    ...
    default_quota = models.PositiveIntegerField(
        null=True, blank=True, verbose_name=_("Default Quota")
    )
    ...
    def __str__(self):
        return f"{escape(self.module.name)} - {escape(self.name)}"
...
class PlanFeature(models.Model):
    ...
    quota_override = models.PositiveIntegerField(
        null=True, blank=True, verbose_name=_("Quota Override")
    )
    ...
    def __str__(self):
        return f"{escape(self.plan.name)} - {escape(self.feature.name)}"
