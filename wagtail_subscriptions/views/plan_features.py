...
class PlanFeatureManagementView(AdminSubscriptionMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if plan_id:
            ...
            context["plan"] = plan
            context["plan_features"] = plan.plan_features.all().select_related(
                "feature", "feature__module"
            )
            ...
            context["all_plan_features"] = PlanFeature.objects.all().select_related(
                "plan", "feature", "feature__module"
            )
    ...
    def post(self, request, *args, **kwargs):
        ...
        if action == "add_feature":
            ...
            plan_feature, created = PlanFeature.objects.get_or_create(
                plan=plan, feature=feature, defaults={"is_included": True}
            )
