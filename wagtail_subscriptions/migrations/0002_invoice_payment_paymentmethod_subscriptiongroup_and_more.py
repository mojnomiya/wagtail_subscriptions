    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "external_id",
                    models.CharField(max_length=255, verbose_name="External Event ID"),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="usage_records",
                to="wagtail_subscriptions.subscription",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="subscription_groups", to="auth.permission"
            ),
        ),
        migrations.AddField(
            model_name="subscriptiongroup",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="wagtail_subscriptions.customer",
            ),
        ),
        migrations.AddField(
            model_name="payment",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                on_delete=django.db.models.deletion.CASCADE,
                related_name="payments",
                to="wagtail_subscriptions.invoice",
            ),
        ),
        migrations.AddField(
            model_name="payment",
            ...
            field=models.ForeignKey(
                ...
                to="wagtail_subscriptions.paymentmethod",
            ),
        ),
        migrations.AddField(
            model_name="payment",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="wagtail_sub_subscri_062dc5_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="usagerecord",
            index=models.Index(
                ...
                name="wagtail_sub_period__28ea1a_idx",
            ),
        ),
        migrations.AlterUniqueTogether(
            name="usagerecord",
        ...
        migrations.AddIndex(
            model_name="auditlog",
            index=models.Index(
                fields=["user", "created_at"], name="wagtail_sub_user_id_audit_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="auditlog",
            index=models.Index(
                ...
                name="wagtail_sub_model_n_audit_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="auditlog",
            index=models.Index(
                fields=["action", "created_at"], name="wagtail_sub_action_audit_idx"
            ),
        ),
    ]
