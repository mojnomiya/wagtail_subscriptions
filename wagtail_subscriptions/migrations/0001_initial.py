    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "default_quota",
                    models.PositiveIntegerField(
                        blank=True, null=True, verbose_name="Default Quota"
                    ),
                ),
                (
                    "quota_unit",
                    models.CharField(
                        blank=True, max_length=50, verbose_name="Quota Unit"
                    ),
                ),
                ("is_active", models.BooleanField(default=True, verbose_name="Active")),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="wagtail_subscriptions.module",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "payment_processor",
                    models.CharField(default="stripe", max_length=50),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="wagtail_subscriptions.subscriptionplan",
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_included",
                    models.BooleanField(default=True, verbose_name="Included"),
                ),
                (
                    "quota_override",
                    models.PositiveIntegerField(
                        blank=True, null=True, verbose_name="Quota Override"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="wagtail_subscriptions.feature",
                    ),
                ),
                (
                    "plan",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "status"], name="wagtail_sub_user_id_b8e5c7_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="subscription",
            index=models.Index(
                fields=["external_id"], name="wagtail_sub_externa_4b8c8a_idx"
            ),
        ),
